(function(e) {
    ...
    function l(s) {
        ...
        i = null;
        t.hide();
        e("body.f-bg").removeClass("zoomed");
        n.empty();
    }
    function c() {
        s = e(window).width();
    ...
    e("body.f-bg").append('<div id="zoom"><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div></div>');
    var t = e("#zoom").hide(),
    n = e("#zoom .content"),
    r = false,
    i = null,
