...
$.fn.html5uploader = function(opts){
	...
	var defaults = {
		...
		itemTemplate:'<li id="${fileID}file"><div><div class="progress"><div class="progressbar"></div></div></div><span class="filename">${fileName}</span><span class="progressnum">0/${fileSize}</span><a class="uploadbtn">上传</a><a style="background-color:#1AA5D9;"></a><a class="delfilebtn">删除</a></li>',//上传队列显示的模板,最外层标签使用<li>
	...
	this.each(function(){
		...
		inputstr += '/>';
		inputstr += '<a href="javascript:void(0)" class="uploadfilebtn btn btn-white">';
